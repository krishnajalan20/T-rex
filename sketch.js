...
function setup() {
  ...
  //MAKING AN IVISIBLE GROUND SO THAT IT LOOKS LIKE REAL
 ...
 // console.log("this is ",gameState)
  ...
  if(gameState === PLAY){
    ...
    if(obstaclesGroup.isTouching(trex)){
     ...
     // RESETTING ITS VELOCITY
     obstaclesGroup.setVelocityXEach(0);
     cloudsGroup.setVelocityXEach(0);
     
     // TO STOP FROM DISSAPEARING
...
function reset(){
  ...
  //OBSTACLES AND CLOUDS SHOULD DESTROY
  obstaclesGroup.destroyEach();
  cloudsGroup.destroyEach();
  
  // RESTART AND GAMEOVER BECAMES INVISIBLE
  restart.visible = false;
  gameOver.visible = false; 
  score = 0;
}
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   ...
   if(frameCount%100===0){
      obstacle.velocityX = obstacle.velocityX-0.2;
      }
